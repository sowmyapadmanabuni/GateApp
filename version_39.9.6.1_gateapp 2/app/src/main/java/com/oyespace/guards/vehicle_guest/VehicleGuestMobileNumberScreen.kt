...
class VehicleGuestMobileNumberScreen : BaseKotlinActivity() , View.OnClickListener, CountryCodePicker.OnCountryChangeListener{
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id) {
            ...
            R.id.Btn_SendOtp ->{
                Toast.makeText(this@VehicleGuestMobileNumberScreen, "Coming soon", Toast.LENGTH_LONG)
                    .show()
            }
...
//                            +" "+textview.text+" "+countryCode);
            ...
            R.id.btn_nobalance->{
                ...
                val d = Intent(this@VehicleGuestMobileNumberScreen, Vehicle_Guest_MobileNumberScreenwithOTP::class.java)
                d.putExtra(UNITID, intent.getStringExtra(UNITID))
                d.putExtra(UNITNAME, intent.getStringExtra(UNITNAME))
                d.putExtra(FLOW_TYPE, intent.getStringExtra(FLOW_TYPE))
                d.putExtra(VISITOR_TYPE, intent.getStringExtra(VISITOR_TYPE))
...
//                        Toast.makeText(this,"Mobile Number already used for Visitor Entry", Toast.LENGTH_SHORT).show()
                        val builder = AlertDialog.Builder(this@VehicleGuestMobileNumberScreen)
                      //  builder.setTitle("Vendor Entry already done")
                        builder.setMessage("This number is being used by a person already in")
                        builder.setPositiveButton("Ok") { dialog, which ->

//                            val d = Intent(this@VehicleGuestMobileNumberScreen, Dashboard::class.java)
//                            startActivity(d)
                            finish()
                            dialog.dismiss()
                        }
...
//                val i_delivery = Intent(this@VehicleGuestMobileNumberScreen, Dashboard::class.java)
...
//        super.onBackPressed()
//        val intent = Intent(this@VehicleGuestMobileNumberScreen, VehicleGuestUnitScreen::class.java)
...
//    }
    ...
    fun getCallDetails(context: Context): String {
        ...
        while (managedCursor.moveToNext()) {
            ...
            Log.d("CallTime1 ", callDayTime.toString()+"Phone Number:--- $phNumber \\nCall Type:--- $dir \\nCall Date:--- $callDayTime \\nCall duration in sec :--- $callDuration")
                ...
                .subscribeWith(object : CommonDisposable<GetAccountDetailsByMobResp<AccountByMobile>>() {
                    override fun onSuccessResponse(globalApiObject: GetAccountDetailsByMobResp<AccountByMobile>) {
                        if (globalApiObject.data!=null) {
                            ...
                            val d = Intent(this@VehicleGuestMobileNumberScreen, VehicleGuestAddCarFragment::class.java)
//
...
//    }
    ...
    override fun onBackPressed() {
        super.onBackPressed()
//        val intent= Intent(this@VehicleGuestMobileNumberScreen, Dashboard::class.java)
//        startActivity(intent)
        finish()
    }
