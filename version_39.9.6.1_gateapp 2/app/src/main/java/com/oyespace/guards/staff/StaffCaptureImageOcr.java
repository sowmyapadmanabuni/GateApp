...
public class StaffCaptureImageOcr extends Activity implements View.OnClickListener,ResponseHandler  {
            ...
            case R.id.buttonNext:
                ...
                if(!vehicalnumber.getText().toString().matches("")){
                   // checkValidateUserVehical(vehicalnumber.getText().toString());
                    ...
                    Intent i_vehicle = new Intent(StaffCaptureImageOcr.this, StaffEntryRegistration.class);
                    i_vehicle.putExtra(WORKER_ID, getIntent().getStringExtra(WORKER_ID));
                    ...
                    showToast(StaffCaptureImageOcr.this,"Enter Vehicle number");
                }
...
//            });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (requestCode == StaffCaptureImageOcr.REQUEST_CAMERA) {
