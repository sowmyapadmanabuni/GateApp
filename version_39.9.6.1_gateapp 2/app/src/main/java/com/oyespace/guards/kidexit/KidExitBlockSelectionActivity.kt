...
class KidExitBlockSelectionActivity : BaseKotlinActivity(), View.OnClickListener {
    ...
    private fun setSearchUnitsAdapter() {
        mSearchUnitsAdapter =
            UnitSearchResultAdapter(
                this@KidExitBlockSelectionActivity,
                searched,
                clickListener = { unit, index ->
                    onSearchResultClick(unit, index)
                })
        rcv_searched_units.adapter = mSearchUnitsAdapter
        rcv_searched_units.layoutManager = LinearLayoutManager(this@KidExitBlockSelectionActivity)
    ...
    private fun setUnitsAdapter() {
        ...
        rcv_selected_units.layoutManager = GridLayoutManager(this@KidExitBlockSelectionActivity, 5)
    ...
    private fun setBlockAdapter() {
        ...
        rcv_blocks.layoutManager = GridLayoutManager(this@KidExitBlockSelectionActivity, 5)
...
//                    val d = Intent(this@KidExitBlockSelectionActivity, PurposeScreen::class.java)
...
//                } else {
                    ...
                    val d = Intent(this@KidExitBlockSelectionActivity, KidExitMobileNumberScreen::class.java)
                    Log.d(
    ...
    private fun onPageClick(selectedBlock: BlocksData, index: Int) {
        val _intent = Intent(this@KidExitBlockSelectionActivity, KidExitUnitSelectionActivity::class.java)
    ...
    private fun getBlocksList() {
        ...
        RetrofitClinet.instance
            ...
            .subscribeWith(object : CommonDisposable<BlocksList<ArrayList<BlocksData>>>() {
                ...
                override fun onErrorResponse(e: Throwable) {
                    dismissProgressrefresh()
                    Toast.makeText(this@KidExitBlockSelectionActivity, "Error ", Toast.LENGTH_LONG).show()
