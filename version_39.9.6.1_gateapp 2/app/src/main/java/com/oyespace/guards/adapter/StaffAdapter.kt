...
class StaffAdapter (val items : ArrayList<Worker>, val mcontext: Context) : androidx.recyclerview.widget.RecyclerView.Adapter<StaffAdapter.StaffViewHolder>() ,Filterable{
