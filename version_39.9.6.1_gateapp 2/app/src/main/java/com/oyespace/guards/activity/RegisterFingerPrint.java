...
//        showToast(this,  "create fmid " + memId);
        ...
        if (RealmDB.fingercount(memId) == 10) {
//
...
//            dlgAlert.create().show();
                new AlertDialog.Builder(RegisterFingerPrint.this)
                        .setTitle("Finger Print Registration")
...
//    	unregisterReceiver(mUsbReceiver);
    ...
    public Bitmap toGrayscale(byte[] mImageBuffer) {
        ...
        for (int i = 0; i < mImageBuffer.length; i++) {
            ...
            Bits[i * 4] = Bits[i * 4 + 1] = mImageBuffer[i];
    ...
    public void onSuccess(String responce, Object data, int urlId, int position) {
        ...
        if (urlId == URLData.URL_SAVE_FINGERPRINT.getUrlId()) {
            ...
            if (loginDetailsResponce != null) {
                Log.d("str3", "str3: " + urlId + " id " + position + " " + memId + " " + MemberType + " " + loginDetailsResponce.success);
...
//    }
    ...
    public void highlightFingers() {
        ...
        bl_left_thumb = RealmDB.getMemberFingerExists(memId + "", "left_thumb");
        bl_left_index = RealmDB.getMemberFingerExists(memId + "", "left_index");
        bl_left_middle = RealmDB.getMemberFingerExists(memId + "", "left_centre");
        bl_left_ring = RealmDB.getMemberFingerExists(memId + "", "left_ring");
        bl_left_little = RealmDB.getMemberFingerExists(memId + "", "left_little");

        bl_right_thumb = RealmDB.getMemberFingerExists(memId + "", "right_thumb");
        bl_right_index = RealmDB.getMemberFingerExists(memId + "", "right_index");
        bl_right_middle = RealmDB.getMemberFingerExists(memId + "", "right_centre");
        bl_right_ring = RealmDB.getMemberFingerExists(memId + "", "right_ring");
        bl_right_little = RealmDB.getMemberFingerExists(memId + "", "right_little");
        ...
        if (RealmDB.fingercount(memId) > 3) {
