...
class Vehicle_guest_UnitSelectionActivity : BaseKotlinActivity() , View.OnClickListener  {
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id) {
            ...
            R.id.buttonNext -> {
                    ...
                    val _intent = Intent(this@Vehicle_guest_UnitSelectionActivity, Vehicle_Guest_BlockSelectionActivity::class.java)
    ...
    private fun managePageNumber(){
        if(arrayFullList != null && arrayFullList.size > 0){
            ...
            pageNumberAdapter =
                PaginationAdapter(this@Vehicle_guest_UnitSelectionActivity, pageArrayList,clickListener = {
    ...
    private fun setPageData(){
        ...
        if(arrayFullList.size > LIMIT){
            ...
            rv_unit.showProgress()
                orderListAdapter =
                    Vehicle_guest_UnitSelectionActivity.UnitListAdapter(
                        arrayList,
                        this@Vehicle_guest_UnitSelectionActivity,
                        checkListener = {
            ...
            rv_unit.showProgress()
            orderListAdapter =
                Vehicle_guest_UnitSelectionActivity.UnitListAdapter(arrayFullList, this@Vehicle_guest_UnitSelectionActivity, checkListener = {
                    arr,ischecked -> onCheckUnit(arr, ischecked)
                })
            rv_unit.adapter = orderListAdapter
            orderListAdapter!!.notifyDataSetChanged()
        ...
        RetrofitClinet.instance
            ...
            .subscribeWith(object : CommonDisposable<UnitsList<ArrayList<UnitPojo>>>() {
                ...
                override fun onErrorResponse(e: Throwable) {
                    dismissProgressrefresh()
                    Toast.makeText(this@Vehicle_guest_UnitSelectionActivity, "No Units Found ", Toast.LENGTH_LONG).show()

                }

                override fun noNetowork() {
                    dismissProgressrefresh()
                    Toast.makeText(this@Vehicle_guest_UnitSelectionActivity, "No network call ", Toast.LENGTH_LONG).show()
                }
            })
