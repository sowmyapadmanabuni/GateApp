...
public class StaffAddCarFragment extends BaseKotlinActivity implements ResponseHandler, View.OnClickListener {
...
//        }
        ...
        imageView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View dialogView = LayoutInflater.from(StaffAddCarFragment.this).inflate(R.layout.dialog_big_image, viewGroup, false);


                AlertDialog.Builder builder = new AlertDialog.Builder(StaffAddCarFragment.this);
...
//                            .into(imageView1);
        ...
        iv_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View dialogView = LayoutInflater.from(StaffAddCarFragment.this).inflate(R.layout.layout_editname_dailog, viewGroup, false);
...
//
    ...
    private void setviewPager(final String selectedImagePath, final Context context) {
        try {
            ...
            imageAdapter = new ImageAdapter(list, StaffAddCarFragment.this, "On");
...
//                }
            ...
            public void onFailure(Call<StaffImageRes> call, Throwable t) {
                Toast.makeText(StaffAddCarFragment.this, t.toString(), Toast.LENGTH_LONG).show();
                call.cancel();
            }
        });
