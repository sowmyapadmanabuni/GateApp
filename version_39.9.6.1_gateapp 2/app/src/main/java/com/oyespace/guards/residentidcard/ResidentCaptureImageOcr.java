...
public class ResidentCaptureImageOcr extends Activity implements View.OnClickListener, ResponseHandler {
        ...
        switch (v.getId()) {
            ...
            case R.id.buttonNext:
                ...
                if(!vehicalnumber.getText().toString().matches("")){
                    ...
                    showToast(ResidentCaptureImageOcr.this,"Enter Vehicle number");
                }
