...
public class GuestCaptureImageOcr extends Activity implements View.OnClickListener,ResponseHandler  {
            ...
            case R.id.buttonNext:
                ...
                if(!vehicalnumber.getText().toString().matches("")){
                   // checkValidateUserVehical(vehicalnumber.getText().toString());
                    ...
                    Intent i_vehicle = new Intent(GuestCaptureImageOcr.this, GuestEntryRegistration.class);
                    ...
                    showToast(GuestCaptureImageOcr.this,"Enter Vehicle number");
                }
...
//            });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (requestCode == GuestCaptureImageOcr.REQUEST_CAMERA) {
