...
//            ).show()
    ...
    var fingerDetectedHandler: Handler = object : Handler() {
        ...
        override fun handleMessage(msg: Message) {
            Toast.makeText(this@EditBiometric, "capture finger" , Toast.LENGTH_LONG).show()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ddc = Intent(this@EditBiometric, BackgroundSyncReceiver::class.java)
        ...
        try {
            if (v === this.mButtonRegister1) {
                ...
                if (mRegisterImage != null) {
                    mRegisterImage = null
                  //  Toast.makeText(this@EditBiometric, "mRegisterImageNull" + mRegisterImage, Toast.LENGTH_LONG).show()
                }
...
//            }
               ...
               // Toast.makeText(this@EditBiometric, " E " + result.toString(), Toast.LENGTH_LONG).show()
                ...
                if (result.toString() == "52" || result.toString() == "0" || result.toString().equals(0)) {
                   //   Toast.makeText(this@EditBiometric, " ElseD: " + result.toString(), Toast.LENGTH_LONG).show()
                }
                ...
                if(result.toString().equals("54"))
                {
                      ...
                      //Toast.makeText(this@EditBiometric, " Blue: " + result.toString(), Toast.LENGTH_LONG).show()
...
//            val d = Intent(this@EditBiometric, StaffDetails::class.java)
