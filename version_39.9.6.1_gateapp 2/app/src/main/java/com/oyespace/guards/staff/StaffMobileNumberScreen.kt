...
class StaffMobileNumberScreen : BaseKotlinActivity(), View.OnClickListener,
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id) {
            ...
            R.id.Btn_SendOtp -> {
                ...
                Toast.makeText(this@StaffMobileNumberScreen, "Coming soon", Toast.LENGTH_LONG)
                    .show()
            }

            R.id.buttonSkip -> {
                val d = Intent(this@StaffMobileNumberScreen, StaffNameEntryScreen::class.java)
                Log.d(
            ...
            R.id.btn_nobalance -> {
                ...
                val d = Intent(this@StaffMobileNumberScreen, StaffMobileNumberScreenwithOTP::class.java)
                d.putExtra(UNITID, intent.getStringExtra(UNITID))
                d.putExtra(UNITNAME, intent.getStringExtra(UNITNAME))
                d.putExtra(FLOW_TYPE, intent.getStringExtra(FLOW_TYPE))
                d.putExtra(VISITOR_TYPE, intent.getStringExtra(VISITOR_TYPE))
            ...
            R.id.buttonNext -> {
                ...
                if (textview.text.length == 13) {
                    ...
                    if (!allowEntry) {
                        ...
                        val builder = AlertDialog.Builder(this@StaffMobileNumberScreen)
...
//        Ed_phoneNum.setText(getCallDetails(this@MobileNumberScreen))
        ...
        Btn_SendOtp.setOnClickListener {
            ...
            fun DisplayProgressDialog() {
                ...
                pDialog = ProgressDialog(this@StaffMobileNumberScreen)
