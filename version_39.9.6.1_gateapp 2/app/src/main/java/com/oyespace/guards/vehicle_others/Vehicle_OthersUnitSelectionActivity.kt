...
class Vehicle_OthersUnitSelectionActivity : BaseKotlinActivity() , View.OnClickListener  {
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id) {
            ...
            R.id.buttonNext -> {
                    ...
                    val _intent = Intent(this@Vehicle_OthersUnitSelectionActivity, Vehicle_Others_BlockSelectionActivity::class.java)
    ...
    private fun managePageNumber(){
        if(arrayFullList != null && arrayFullList.size > 0){
            ...
            pageNumberAdapter =
                PaginationAdapter(this@Vehicle_OthersUnitSelectionActivity, pageArrayList,clickListener = {
    ...
    private fun setPageData(){
        ...
        if(arrayFullList.size > LIMIT){
            ...
            rv_unit.showProgress()
                orderListAdapter =
                    Vehicle_OthersUnitSelectionActivity.UnitListAdapter(
                        arrayList,
                        this@Vehicle_OthersUnitSelectionActivity,
                        checkListener = {
            ...
            rv_unit.showProgress()
            orderListAdapter =
                Vehicle_OthersUnitSelectionActivity.UnitListAdapter(arrayFullList, this@Vehicle_OthersUnitSelectionActivity, checkListener = {
                    arr,ischecked -> onCheckUnit(arr, ischecked)
                })
            rv_unit.adapter = orderListAdapter
            orderListAdapter!!.notifyDataSetChanged()
        ...
        RetrofitClinet.instance
            ...
            .subscribeWith(object : CommonDisposable<UnitsList<ArrayList<UnitPojo>>>() {
                ...
                override fun onErrorResponse(e: Throwable) {
                    dismissProgressrefresh()
                    Toast.makeText(this@Vehicle_OthersUnitSelectionActivity, "No Units Found ", Toast.LENGTH_LONG).show()

                }

                override fun noNetowork() {
                    dismissProgressrefresh()
                    Toast.makeText(this@Vehicle_OthersUnitSelectionActivity, "No network call ", Toast.LENGTH_LONG).show()
                }
            })
