...
public class VehicleOthersViewPagerAdapter extends PagerAdapter {
//     Context mContext;
//    int pos;
...
//    }
    ...
    public VehicleOthersViewPagerAdapter(Context context) {

        mContext = context;
        imagesList=new ArrayList<>();
        imagesList=VehicleOthersAddCarFragment.list;
