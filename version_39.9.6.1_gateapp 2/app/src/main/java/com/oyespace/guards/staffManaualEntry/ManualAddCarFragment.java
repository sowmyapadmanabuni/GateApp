...
//        }
        ...
        imageView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View dialogView = LayoutInflater.from(ManualAddCarFragment.this).inflate(R.layout.dialog_big_image, viewGroup, false);
...
//               .placeholder(R.drawable.user_icon_black).error(R.drawable.user_icon_black).into(imageView1);
        ...
        iv_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View dialogView = LayoutInflater.from(ManualAddCarFragment.this).inflate(R.layout.layout_editname_dailog, viewGroup, false);
