...
class GuestBlockTabsActivity : BaseKotlinActivity(), OnDataPass {
    var clickable1 = 0
        ...
        RetrofitClinet.instance
            ...
            .subscribeWith(object : CommonDisposable<BlocksList<ArrayList<BlocksData>>>() {
                ...
                override fun onErrorResponse(e: Throwable) {
                    dismissProgressrefresh()
                    Toast.makeText(this@GuestBlockTabsActivity, "Error ", Toast.LENGTH_LONG).show()
    ...
    private fun onNextPress() {
        ...
        if (selected.size > 0) {
            ...
            if (unitNames.length > 0) {
                ...
                val d = Intent(this@GuestBlockTabsActivity, GuestMobileNumberScreen::class.java)
                Log.d(
                    "intentdata NameEntr",
