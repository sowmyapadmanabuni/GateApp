...
import com.oyespace.guards.pertroling.GeofenceErrorMessages;
...
public class GeofenceTransitionsJobIntentService extends JobIntentService {
    ...
    private void sendNotification(String notificationDetails) {
        ...
        Intent notificationIntent = new Intent(getApplicationContext(), PatrollingLocActivity.class);

        // Construct a task stack.
        TaskStackBuilder stackBuilder = TaskStackBuilder.create(this);

        // Add the main Activity to the task stack as the parent.
        stackBuilder.addParentStack(PatrollingLocActivity.class);
