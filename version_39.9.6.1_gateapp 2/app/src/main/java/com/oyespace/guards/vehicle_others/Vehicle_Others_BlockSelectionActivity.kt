...
class Vehicle_Others_BlockSelectionActivity : BaseKotlinActivity(), View.OnClickListener {
    ...
    private fun setSearchUnitsAdapter(){
        ...
        rcv_searched_units.layoutManager =
            LinearLayoutManager(this@Vehicle_Others_BlockSelectionActivity)
    ...
    private fun setUnitsAdapter(){
        ...
        rcv_selected_units.layoutManager =
            GridLayoutManager(this@Vehicle_Others_BlockSelectionActivity, 5)
    ...
    private fun setBlockAdapter(){
        ...
        rcv_blocks.layoutManager = GridLayoutManager(this@Vehicle_Others_BlockSelectionActivity, 5)
