...
class KidExitNameEntryScreen : BaseKotlinActivity() , View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id) {
            ...
            R.id.buttonNext ->{
                ...
                if(Ed_Name.text.length<2  ) {
                ...
                else if(ed_KidName!!.text.length<2){
                    buttonNext.isEnabled = true
                    buttonNext.isClickable = true
                    Toast.makeText(this,"Enter Valid Kid Name", Toast.LENGTH_SHORT).show()
                }
                    ...
                    if (ed_dob!!.length() == 0) {
                        ...
                        val d = Intent(this@KidExitNameEntryScreen, KidExitAddCarFragment::class.java)
...
//                            +" "+getIntent().getStringExtra(MOBILENUMBER)+" "+getIntent().getStringExtra(COUNTRYCODE)+" "+Ed_Name.text);
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lyt_kid!!.visibility=View.VISIBLE
        ...
        ed_dob!!.setOnClickListener {
            ...
            val d = cal.get(Calendar.DAY_OF_MONTH)
             ...
             datepickerdialog = DatePickerDialog(this@KidExitNameEntryScreen, DatePickerDialog.OnDateSetListener { view, year, monthOfYear, dayOfMonth ->
