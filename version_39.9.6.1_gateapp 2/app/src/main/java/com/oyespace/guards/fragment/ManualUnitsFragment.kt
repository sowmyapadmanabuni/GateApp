...
class ManualUnitsFragment : Fragment() {
    ...
    fun newInstance(data: String?): ManualUnitsFragment? {
        val fragment: ManualUnitsFragment = ManualUnitsFragment()
        val args = Bundle()
    ...
    override fun onCreateView(
      ...
      //  empty!!.text=getArguments()!!.getString("someValue")
        val activity: ManualBlockTabsActivity = activity as ManualBlockTabsActivity
        ...
        try {
          ...
          //  var json: String = myDataFromActivity
            var selArray: Array<UnitPojo> = Gson().fromJson(myDataFromActivity, Array<UnitPojo>::class.java)
