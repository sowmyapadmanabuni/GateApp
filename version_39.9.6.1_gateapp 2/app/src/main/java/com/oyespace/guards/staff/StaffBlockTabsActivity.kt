...
class StaffBlockTabsActivity : BaseKotlinActivity(), OnDataPass {
    var clickable1 = 0
        ...
        RetrofitClinet.instance
            ...
            .subscribeWith(object : CommonDisposable<BlocksList<ArrayList<BlocksData>>>() {
                ...
                override fun onErrorResponse(e: Throwable) {
                    dismissProgressrefresh()
                    Toast.makeText(this@StaffBlockTabsActivity, "Error ", Toast.LENGTH_LONG).show()
        ...
        if (selected.size > 0) {
            ...
            if (unitNames.length > 0) {
                ...
                if (intent.getStringExtra(COMPANY_NAME) != null && intent.getStringExtra(COMPANY_NAME).equals("Others")) {
                    val d = Intent(this@StaffBlockTabsActivity, StaffPurposeScreen::class.java)
...
// " " + intent.getStringExtra(UNITID) + " " + Ed_phoneNum.text + " " + countryCode );
                    ...
                    val d = Intent(this@StaffBlockTabsActivity, StaffMobileNumberScreen::class.java)
                    Log.d(
