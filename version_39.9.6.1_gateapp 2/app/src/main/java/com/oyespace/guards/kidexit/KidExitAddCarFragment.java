...
public class KidExitAddCarFragment extends BaseKotlinActivity implements ResponseHandler, View.OnClickListener {
...
//        }
        ...
        imageView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View dialogView = LayoutInflater.from(KidExitAddCarFragment.this).inflate(R.layout.dialog_big_image, viewGroup, false);


                AlertDialog.Builder builder = new AlertDialog.Builder(KidExitAddCarFragment.this);
...
//                        .into(imageView1);
        ...
        iv_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View dialogView = LayoutInflater.from(KidExitAddCarFragment.this).inflate(R.layout.layout_editname_dailog, viewGroup, false);
        ...
        if (urlId == URLData.URL_STAFF_REGISTRATION.getUrlId()) {
            ...
            if (workerResponce != null) {
                ...
                if (workerResponce.success.equalsIgnoreCase("true")) {
                    ...
                    Intent ddc = new Intent(KidExitAddCarFragment.this, BackgroundSyncReceiver.class);
                    ...
                    sendBroadcast(ddc);
                    Intent ddc1 = new Intent(KidExitAddCarFragment.this, BackgroundSyncReceiver.class);
...
//
    ...
    private void setviewPager(final String selectedImagePath, final Context context) {
        try {
            ...
            imageAdapter = new ImageAdapter(list, KidExitAddCarFragment.this, "On");
...
//                }
            ...
            public void onFailure(Call<StaffImageRes> call, Throwable t) {
                Toast.makeText(KidExitAddCarFragment.this, t.toString(), Toast.LENGTH_LONG).show();
                call.cancel();
            }
        });
